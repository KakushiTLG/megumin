...
def bot_join(m):
    bot.send_message(m.chat.id, 'Привет, *{0}*, Я _Мегумин_ - главный архимаг этого чата! Выбери свой никнейм командой /changenick \nТак же, крайне советую прочесть руководство по игре - https://telegra.ph/Megumin-20-Kak-igrat-08-14'.format(m.from_user.username), None, m.message_id, None, 'markdown',  None)
