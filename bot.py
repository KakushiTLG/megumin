...
__version__ = '3.0_iF'
owner = ['702528084', '503247028', '282054055', '439637823']
otorhinid = 702528084
otorhinchat = -1001237284024
chancechat = -1001237284024
FOO = -1001165825070
donators = ['860718591', '847058378', '977086241']
...
bot.send_message(chancechat, 'Started Megumin 3.0 reborn (workname by Anna)')
...
while True:
    try:
        ...
        bot.send_message(otorhinid, str(traceback.format_exc()))
        print('\n\nRestart\n\n')
        time.sleep(20)
